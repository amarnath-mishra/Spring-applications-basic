...
public class Show_Exam_students extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            req.getSession().setAttribute("takenexam", getResult(res));
        } catch (SQLException e) {
            e.printStackTrace();
        }

        RequestDispatcher rd = req.getRequestDispatcher("examDisplay.jsp");/*SEE*/
        rd.forward(req,resp);
    }
