...
public class ExcelReader extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String dir = "/home/amarnath/workspace/ExcelUploadRead/temp/";
		String temp = "";
			...
			while (celliterator.hasNext()) {
				...
				if (flag == 0) {
					if (type == Cell.CELL_TYPE_STRING) {
						...
						error = error + " cell no." + c + " at row " + ro
								+ " |";
					}
				} else {
					...
					if (c == 1) {
						...
						if (type == Cell.CELL_TYPE_NUMERIC && (!(type == Cell.CELL_TYPE_BLANK))) {
							...
							ans=ans+t+"|";
							if (t < 2014 || t > 2017) {
								error = error + "year at cell " + c + " row " + ro
										+ " should be 2014 -2017|";
							}
						}
					}
		...
		if (error.length() == 0) {
			...
			ans="";
			error="";
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/jsp/readexcel.jsp");
